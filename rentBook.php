...
<div class="search-container">
  ...
  <section id="book-list">
    ...
    <div class="book">
      ...
      <p>Rent Price: $<?php echo $price; ?></p>
      <p>Additional $2 will be added as delivery charge with Rent Price</p>
...
function redirectToCheckoutForm() {
    ...
    const redirectTo = `rent_form.php?cartItems=${encodedCartItemsJson}&total=${encodedTotal}`;
